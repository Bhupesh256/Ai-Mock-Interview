...
const page = () => {
  return (
    <div className="mt-10">
      ...
      <h2 class="text-md text-gray-500 text-center">Give mock interview in just 3 simplar easy step</h2>
      <div class="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 my-10">
        <a
          class="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
          href="#"
        >
          <svg
